...
@Controller
@RequestMapping("/pet/petSitter")
public class PetPetSitterController extends AbstractController {
	...
	public ModelAndView list(){
		...
		result.addObject("requestURI", "pet/petSitter/list.do");
	...
	public ModelAndView see(@RequestParam int petId) {
		...
		requestURI	= "pet/petSitter/see.do?petId=" + petId;		
	...
	public ModelAndView save(@Valid Pet pet, BindingResult binding){
		...
		if(binding.hasErrors()){
			...
			try{
				petService.save(pet);
				result = new ModelAndView("redirect:/pet/petSitter/list.do");
	...
	protected  ModelAndView createEditModelAndView(Pet pet, String message) {
		...
		requestURI = "pet/petSitter/edit.do";
	...
	protected ModelAndView createAddPhotoModelAndView(Pet pet, String message) {
		...
		requestURI = "pet/petSitter/addPhoto.do";
