...
<div class="widget-container boxed">
   ...
   <script async="async" src="https://www.paypalobjects.com/js/external/paypal-button.min.js?merchant=${registration.trip.vehicle.petShipper.email}"
	    data-button="buynow" 
	    data-name='<spring:message code = "paypal.description"></spring:message>' 
	    data-quantity="1" 
	    data-amount="${registration.trip.cost}" 
	    data-currency="EUR" 
