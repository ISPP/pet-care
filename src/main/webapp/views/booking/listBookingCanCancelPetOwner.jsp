...
<display:table name="bookings" id="row" requestURI="${requestUri}"
	...
	<spring:message code="booking.cancel.title" var="cancelColumn"></spring:message>
	<display:column title="${cancelColumn}" >
		
	<a href="booking/petOwner/cancel.do?id=${row.id}"> <spring:message
						code="booking.cancel" />
	</a>
