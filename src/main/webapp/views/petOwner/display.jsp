...
<div class="col-md-4">
	...
	<img class="userPhotoAvatar" alt="Your AVATAR" src="images/petOnwer-index.jpg">
	</jstl:if>
	</jstl:if>
	<br>
	<br>
...
<br />
		...
		<acme:cancel code="owner.edit"
			url="/petOwner/petOwner/edit.do?petOwnerId=${petOwner.id}" />
      ...
      <div class="panel-heading"> <strong style="font-size:200%;"> ${petOwner.name} ${petOwner.surname}</strong></div>
	...
	<br /> ${petOwner.email} <br /> <a href="${petOwner.homePage}"
